...
var ContextMenuTrigger = function (_Component) {
    ...
    function ContextMenuTrigger() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ContextMenuTrigger.__proto__ || Object.getPrototypeOf(ContextMenuTrigger)).call.apply(_ref, [this].concat(args))), _this), _this.touchHandled = false, _this.touchstartTimeoutId = null, _this.abortTimer = function () {
            clearTimeout(_this.touchstartTimeoutId);
            _this.touchstartTimeoutId = null;
